...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/isack-mwangasu/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@isak.co.ke",
    icon: Instagram,
    url: "https://www.instagram.com/isak.co.ke/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@mwangasuisack8837",
    icon: Youtube,
    url: "https://www.youtube.com/@mwangasuisack8837",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Isack-Mwangasu",
    icon: Github,
    url: "https://github.com/Isack-Mwangasu",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@isak.co.ke",
    color: "black",
